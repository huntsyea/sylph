...
<Preview codeblock>
  <div>
    <div className="text-2xl font-medium">Heading 1</div>
    <div />
    <h2>Heading 2</h2>
  </div>
</Preview>
...
Markdown links stay in the current tab. When opening a trusted external destination in a new tab is intentional, use the registered component; it adds the required relationship attributes:

```mdx
<Link href="https://nextjs.org/docs" newTab>
